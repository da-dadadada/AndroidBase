package com.lht.chuangyiyun.util.bitmap;
...
/**
 * <p><b>Package</b> com.lht.chuangyiyun.util.bitmap
...
public class BitmapUtils {
    ...
    public static String compressBitmap(Context context, String srcPath, int rqsW, int rqsH, boolean isDelSrc) {
        ...
        try {
            ...
            Log.e(BitmapUtils.class.getSimpleName(),"BitmapHelper-->compressBitmap:"+ e.getMessage() + "");
        }
        return desPath;
    }
