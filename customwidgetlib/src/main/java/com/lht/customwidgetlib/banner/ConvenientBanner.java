...
import com.lht.customwidgetlib.banner.adapter.CBPageAdapter;
import com.lht.customwidgetlib.banner.holder.CBViewHolderCreator;
import com.lht.customwidgetlib.banner.listener.CBPageChangeListener;
import com.lht.customwidgetlib.banner.listener.OnItemClickListener;
import com.lht.customwidgetlib.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    /**
     * 指示器的方向
     * @param align  三个方向：居�?（RelativeLayout.ALIGN_PARENT_LEFT），居中 （RelativeLayout.CENTER_HORIZONTAL），居右 （RelativeLayout.ALIGN_PARENT_RIGHT�?
     * @return
     */
    ...
    //触碰控件的时候，翻页应该停止，离�?��时�?如果之前是开启了翻页的话则重新启动翻�?
    @Override
