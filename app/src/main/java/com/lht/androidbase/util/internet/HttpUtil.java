package com.lht.androidbase.util.internet;
...
public class HttpUtil {
	...
	public void getWithoutParams(Context mContext, String urlString,
			AsyncHttpResponseHandler res) {
		getClient().get(mContext, urlString, res);
	}

	public void getWithParams(Context mContext, String urlString,
			RequestParams params, AsyncHttpResponseHandler res) {
		getClient().get(mContext, urlString, params, res);
	}

	public void getWithParams(String urlString, RequestParams params,
			AsyncHttpResponseHandler res) {
		getClient().get(urlString, params, res);
	}

	public void postWithEntity(Context context, String urlString,
			HttpEntity entity, String contentType, AsyncHttpResponseHandler res) {
		getClient().post(context, urlString, entity, contentType, res);
	}

	public void getWithParams(Context mContext, String tag, String urlString,
			RequestParams params, AsyncHttpResponseHandler res) {
	...
	public void get(String headImgUrl,
	...
	public void postWithParams(Context mContext, String urlString,
			RequestParams params, AsyncHttpResponseHandler res) {
		getClient().post(mContext, urlString, params, res);
	}

	public void postWithParams(Context mContext, String tag, String urlString,
			RequestParams params, AsyncHttpResponseHandler res) {
		getClient().post(mContext, urlString, params, res).setTag(tag);
	}

	public void postWithParams(Context mContext, String url, HttpEntity entity,
	...
	public void setTag(Context mContext, String urlString,
			AsyncHttpResponseHandler res, int tag) {
		getClient().get(mContext, urlString, res).setTag(tag);
	}

	public void setHandle(Context mContext, String urlString,
			AsyncHttpResponseHandler res) {
	...
	private RequestHandle getWithoutParams2(Context mContext, String urlString,
			AsyncHttpResponseHandler res) {
